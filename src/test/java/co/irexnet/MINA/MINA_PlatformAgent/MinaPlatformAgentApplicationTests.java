...
import co.irexnet.MINA.MINA_PlatformAgent.controller.CallbackController;
...
import co.irexnet.MINA.MINA_PlatformAgent.util.CommonValue;

@Slf4j
@SpringBootTest
class MinaPlatformAgentApplicationTests {
    ...
    public byte[] getCRC16(byte[] bytes) {
    	...
    	int[] CRC = TABLE_POLYNO;
    	  ...
    	  System.out.println("Integer " + Integer.toHexString(icrc)); // test   �굹���빞�릺�뒗 媛� 
    	
    	  
    
    	  return fnShortToBytes((short)icrc,0);//HtypeCast�쓽 short瑜� byte濡� 蹂��솚�빐二쇰뒗 �븿�닔
